...
def _get_kwargs(
    *,
    ...
    ptp_bid_award_mw_from: Union[Unset, float] = UNSET,
    ptp_bid_award_mw_to: Union[Unset, float] = UNSET,
    ptp_bid_price_from: Union[Unset, float] = UNSET,
    ptp_bid_price_to: Union[Unset, float] = UNSET,
    bid_id: Union[Unset, str] = UNSET,
    ...
    params["PTPBidAwardMWFrom"] = ptp_bid_award_mw_from

    params["PTPBidAwardMWTo"] = ptp_bid_award_mw_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-966-er/60_dam_ptp_obl_bid_awards",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        ptp_bid_award_mw_from (Union[Unset, float]):
        ptp_bid_award_mw_to (Union[Unset, float]):
        ptp_bid_price_from (Union[Unset, float]):
        ptp_bid_price_to (Union[Unset, float]):
        bid_id (Union[Unset, str]):
    ...
    kwargs = _get_kwargs(
        ...
        ptp_bid_award_mw_to=ptp_bid_award_mw_to,
