...
def _get_kwargs(
    *,
    ...
    energy_only_bid_award_in_mw_from: Union[Unset, float] = UNSET,
    energy_only_bid_award_in_mw_to: Union[Unset, float] = UNSET,
    ...
    params["energyOnlyBidAwardInMWFrom"] = energy_only_bid_award_in_mw_from

    params["energyOnlyBidAwardInMWTo"] = energy_only_bid_award_in_mw_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-966-er/60_dam_energy_bid_awards",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        energy_only_bid_award_in_mw_from (Union[Unset, float]):
        energy_only_bid_award_in_mw_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        energy_only_bid_award_in_mw_to=energy_only_bid_award_in_mw_to,
