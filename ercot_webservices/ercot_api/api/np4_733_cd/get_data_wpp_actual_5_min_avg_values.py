...
def _get_kwargs(
    *,
    ...
    lz_south_houston_from: Union[Unset, float] = UNSET,
    lz_south_houston_to: Union[Unset, float] = UNSET,
    lz_west_from: Union[Unset, float] = UNSET,
    lz_west_to: Union[Unset, float] = UNSET,
    lz_north_from: Union[Unset, float] = UNSET,
    lz_north_to: Union[Unset, float] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        lz_south_houston_from (Union[Unset, float]):
        lz_south_houston_to (Union[Unset, float]):
        lz_west_from (Union[Unset, float]):
        lz_west_to (Union[Unset, float]):
        lz_north_from (Union[Unset, float]):
        lz_north_to (Union[Unset, float]):
