...
def _get_kwargs(
    *,
    ...
    regup_aawarded_from: Union[Unset, float] = UNSET,
    regup_aawarded_to: Union[Unset, float] = UNSET,
    ...
    ecrsm_awarded_from: Union[Unset, float] = UNSET,
    ecrsm_awarded_to: Union[Unset, float] = UNSET,
    ecrss_awarded_from: Union[Unset, float] = UNSET,
    ecrss_awarded_to: Union[Unset, float] = UNSET,
    ...
    params["ECRSMAwardedFrom"] = ecrsm_awarded_from

    params["ECRSMAwardedTo"] = ecrsm_awarded_to

    params["ECRSSAwardedFrom"] = ecrss_awarded_from

    params["ECRSSAwardedTo"] = ecrss_awarded_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-990-ex/60_sasm_load_res_as_offer_awards",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        regup_aawarded_from (Union[Unset, float]):
        regup_aawarded_to (Union[Unset, float]):
        ...
        ecrsm_awarded_from (Union[Unset, float]):
        ecrsm_awarded_to (Union[Unset, float]):
        ecrss_awarded_from (Union[Unset, float]):
        ecrss_awarded_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        ecrsm_awarded_from=ecrsm_awarded_from,
        ecrsm_awarded_to=ecrsm_awarded_to,
        ecrss_awarded_from=ecrss_awarded_from,
        ecrss_awarded_to=ecrss_awarded_to,
