...
def _get_kwargs(
    *,
    ...
    offec_awarded_from: Union[Unset, float] = UNSET,
    offec_awarded_to: Union[Unset, float] = UNSET,
    ...
    params["OFFECAwardedFrom"] = offec_awarded_from

    params["OFFECAwardedTo"] = offec_awarded_to
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        offec_awarded_from (Union[Unset, float]):
        offec_awarded_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        offec_awarded_from=offec_awarded_from,
        offec_awarded_to=offec_awarded_to,
