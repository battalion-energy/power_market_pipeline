...
def _get_kwargs(
    *,
    ...
    dc_tie: Union[Unset, str] = UNSET,
    gmt_interval_ending_from: Union[Unset, str] = UNSET,
    gmt_interval_ending_to: Union[Unset, str] = UNSET,
    ...
    import_export: Union[Unset, str] = UNSET,
    ...
    params["GMTIntervalEndingFrom"] = gmt_interval_ending_from

    params["GMTIntervalEndingTo"] = gmt_interval_ending_to
    ...
    params["importExport"] = import_export
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-765-cd/approved_dctie_schedules",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        dc_tie (Union[Unset, str]):
        gmt_interval_ending_from (Union[Unset, str]):
        gmt_interval_ending_to (Union[Unset, str]):
    ...
    kwargs = _get_kwargs(
        ...
        dc_tie=dc_tie,
        gmt_interval_ending_from=gmt_interval_ending_from,
        gmt_interval_ending_to=gmt_interval_ending_to,
