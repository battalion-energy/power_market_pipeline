...
def _get_kwargs(
    *,
    ...
    sum_telem_dsr_load_from: Union[Unset, float] = UNSET,
    sum_telem_dsr_load_to: Union[Unset, float] = UNSET,
    sum_telem_dsr_gen_from: Union[Unset, float] = UNSET,
    sum_telem_dsr_gen_to: Union[Unset, float] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sum_telem_dsr_load_from (Union[Unset, float]):
        sum_telem_dsr_load_to (Union[Unset, float]):
        sum_telem_dsr_gen_from (Union[Unset, float]):
        sum_telem_dsr_gen_to (Union[Unset, float]):
