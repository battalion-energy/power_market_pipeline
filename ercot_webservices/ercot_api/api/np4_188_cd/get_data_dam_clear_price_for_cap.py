...
def _get_kwargs(
    *,
    ...
    ancillary_type: Union[Unset, str] = UNSET,
    mcpc_from: Union[Unset, float] = UNSET,
    mcpc_to: Union[Unset, float] = UNSET,
    ...
    params["MCPCFrom"] = mcpc_from

    params["MCPCTo"] = mcpc_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np4-188-cd/dam_clear_price_for_cap",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        ancillary_type (Union[Unset, str]):
        mcpc_from (Union[Unset, float]):
        mcpc_to (Union[Unset, float]):
