...
def _get_kwargs(
    *,
    ...
    total_cleared_asrrspfr_from: Union[Unset, float] = UNSET,
    total_cleared_asrrspfr_to: Union[Unset, float] = UNSET,
    ...
    params["totalClearedASRRSPFRFrom"] = total_cleared_asrrspfr_from

    params["totalClearedASRRSPFRTo"] = total_cleared_asrrspfr_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_cleared_dam_as_rrspfr",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        total_cleared_asrrspfr_from (Union[Unset, float]):
        total_cleared_asrrspfr_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        total_cleared_asrrspfr_to=total_cleared_asrrspfr_to,
        page=page,
        size=size,
        sort=sort,
        dir_=dir_,
