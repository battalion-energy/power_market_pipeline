...
def _get_kwargs(
    *,
    ...
    total_self_arranged_asecrsm_from: Union[Unset, float] = UNSET,
    total_self_arranged_asecrsm_to: Union[Unset, float] = UNSET,
    ...
    params["totalSelfArrangedASECRSMFrom"] = total_self_arranged_asecrsm_from

    params["totalSelfArrangedASECRSMTo"] = total_self_arranged_asecrsm_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_self_arranged_as_ecrsm",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        total_self_arranged_asecrsm_from (Union[Unset, float]):
        total_self_arranged_asecrsm_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        total_self_arranged_asecrsm_to=total_self_arranged_asecrsm_to,
        page=page,
        size=size,
        sort=sort,
        dir_=dir_,
