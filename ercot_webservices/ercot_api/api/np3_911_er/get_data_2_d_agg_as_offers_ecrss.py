...
def _get_kwargs(
    *,
    ...
    ecrss_offer_price_from: Union[Unset, float] = UNSET,
    ecrss_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["ECRSSOfferPriceFrom"] = ecrss_offer_price_from

    params["ECRSSOfferPriceTo"] = ecrss_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_ecrss",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        ecrss_offer_price_from (Union[Unset, float]):
        ecrss_offer_price_to (Union[Unset, float]):
