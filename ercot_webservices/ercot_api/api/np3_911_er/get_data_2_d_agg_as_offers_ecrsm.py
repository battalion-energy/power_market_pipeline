...
def _get_kwargs(
    *,
    ecrsm_offer_price_from: Union[Unset, float] = UNSET,
    ecrsm_offer_price_to: Union[Unset, float] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_ecrsm",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ecrsm_offer_price_from (Union[Unset, float]):
        ecrsm_offer_price_to (Union[Unset, float]):
