...
def _get_kwargs(
    *,
    ...
    offns_offer_price_from: Union[Unset, float] = UNSET,
    offns_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["OFFNSOfferPriceFrom"] = offns_offer_price_from

    params["OFFNSOfferPriceTo"] = offns_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_offns",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        offns_offer_price_from (Union[Unset, float]):
        offns_offer_price_to (Union[Unset, float]):
