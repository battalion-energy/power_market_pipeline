...
def _get_kwargs(
    *,
    ...
    onns_offer_price_from: Union[Unset, float] = UNSET,
    onns_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["ONNSOfferPriceFrom"] = onns_offer_price_from

    params["ONNSOfferPriceTo"] = onns_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_onns",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        onns_offer_price_from (Union[Unset, float]):
        onns_offer_price_to (Union[Unset, float]):
