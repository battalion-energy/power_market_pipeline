...
def _get_kwargs(
    *,
    ...
    rrsffr_offer_price_from: Union[Unset, float] = UNSET,
    rrsffr_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["RRSFFROfferPriceFrom"] = rrsffr_offer_price_from

    params["RRSFFROfferPriceTo"] = rrsffr_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_rrsffr",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        rrsffr_offer_price_from (Union[Unset, float]):
        rrsffr_offer_price_to (Union[Unset, float]):
