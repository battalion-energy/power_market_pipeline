...
def _get_kwargs(
    *,
    ...
    regup_offer_price_from: Union[Unset, float] = UNSET,
    regup_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["REGUPOfferPriceFrom"] = regup_offer_price_from

    params["REGUPOfferPriceTo"] = regup_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_regup",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        regup_offer_price_from (Union[Unset, float]):
        regup_offer_price_to (Union[Unset, float]):
