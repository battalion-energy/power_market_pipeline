...
def _get_kwargs(
    *,
    ...
    regdn_offer_price_from: Union[Unset, float] = UNSET,
    regdn_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["REGDNOfferPriceFrom"] = regdn_offer_price_from

    params["REGDNOfferPriceTo"] = regdn_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_regdn",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        regdn_offer_price_from (Union[Unset, float]):
        regdn_offer_price_to (Union[Unset, float]):
