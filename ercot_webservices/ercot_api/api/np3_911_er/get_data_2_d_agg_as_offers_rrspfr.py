...
def _get_kwargs(
    *,
    ...
    mw_offered_from: Union[Unset, float] = UNSET,
    mw_offered_to: Union[Unset, float] = UNSET,
    rrspfr_offer_price_from: Union[Unset, float] = UNSET,
    rrspfr_offer_price_to: Union[Unset, float] = UNSET,
    ...
    params["RRSPFROfferPriceFrom"] = rrspfr_offer_price_from

    params["RRSPFROfferPriceTo"] = rrspfr_offer_price_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_agg_as_offers_rrspfr",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        mw_offered_from (Union[Unset, float]):
        mw_offered_to (Union[Unset, float]):
        rrspfr_offer_price_from (Union[Unset, float]):
        rrspfr_offer_price_to (Union[Unset, float]):
