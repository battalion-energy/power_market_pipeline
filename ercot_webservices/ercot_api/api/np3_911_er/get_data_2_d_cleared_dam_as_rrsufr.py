...
def _get_kwargs(
    *,
    ...
    total_cleared_asrrsufr_from: Union[Unset, float] = UNSET,
    total_cleared_asrrsufr_to: Union[Unset, float] = UNSET,
    ...
    params["totalClearedASRRSUFRFrom"] = total_cleared_asrrsufr_from

    params["totalClearedASRRSUFRTo"] = total_cleared_asrrsufr_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_cleared_dam_as_rrsufr",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        total_cleared_asrrsufr_from (Union[Unset, float]):
        total_cleared_asrrsufr_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        total_cleared_asrrsufr_to=total_cleared_asrrsufr_to,
        page=page,
        size=size,
        sort=sort,
        dir_=dir_,
