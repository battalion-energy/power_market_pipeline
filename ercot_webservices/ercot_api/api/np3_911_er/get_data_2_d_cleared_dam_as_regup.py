...
def _get_kwargs(
    *,
    ...
    total_cleared_asregup_from: Union[Unset, float] = UNSET,
    total_cleared_asregup_to: Union[Unset, float] = UNSET,
    ...
    params["totalClearedASREGUPFrom"] = total_cleared_asregup_from

    params["totalClearedASREGUPTo"] = total_cleared_asregup_to
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np3-911-er/2d_cleared_dam_as_regup",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        total_cleared_asregup_from (Union[Unset, float]):
        total_cleared_asregup_to (Union[Unset, float]):
    ...
    kwargs = _get_kwargs(
        ...
        total_cleared_asregup_to=total_cleared_asregup_to,
        page=page,
        size=size,
        sort=sort,
        dir_=dir_,
