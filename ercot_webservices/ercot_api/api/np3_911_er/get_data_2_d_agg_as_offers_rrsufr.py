...
def _get_kwargs(
    *,
    rrsufr_offer_price_from: Union[Unset, float] = UNSET,
    rrsufr_offer_price_to: Union[Unset, float] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        rrsufr_offer_price_from (Union[Unset, float]):
        rrsufr_offer_price_to (Union[Unset, float]):
