...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/archive/{emil_id}/download",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Download a collection of EMIL Product archives.
     ...
     Download a collection of EMIL Product archives by generating a JSON request with a single 'docIds'
    element containing the document identifiers you wish to download.
