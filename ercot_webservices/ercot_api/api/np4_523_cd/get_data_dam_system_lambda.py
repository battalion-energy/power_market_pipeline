...
def _get_kwargs(
    *,
    ...
    system_lambda_from: Union[Unset, float] = UNSET,
    system_lambda_to: Union[Unset, float] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/np4-523-cd/dam_system_lambda",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        system_lambda_from (Union[Unset, float]):
        system_lambda_to (Union[Unset, float]):
