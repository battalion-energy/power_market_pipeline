...
def _get_kwargs(
    *,
    cancel_flag: Union[Unset, bool] = UNSET,
    update_time_from: Union[Unset, str] = UNSET,
    update_time_to: Union[Unset, str] = UNSET,
    submit_time_from: Union[Unset, str] = UNSET,
    submit_time_to: Union[Unset, str] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        cancel_flag (Union[Unset, bool]):
        update_time_from (Union[Unset, str]):
        update_time_to (Union[Unset, str]):
        submit_time_from (Union[Unset, str]):
        submit_time_to (Union[Unset, str]):
