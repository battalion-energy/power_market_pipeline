...
class QueryMetadata:
    ...
    Attributes:
        parameter_count (Union[Unset, int]):
        parameters (Union[Unset, QueryMetadataParameters]):
        sorted_by (Union[Unset, str]):
    """

    parameter_count: Union[Unset, int] = UNSET
    parameters: Union[Unset, "QueryMetadataParameters"] = UNSET
    sorted_by: Union[Unset, str] = UNSET
