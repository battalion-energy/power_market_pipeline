#!/usr/bin/env python3
"""
CAISO Data Status Checker

Provides comprehensive status report on all CAISO datasets:
...
Usage:
    python check_caiso_data_status.py
    python check_caiso_data_status.py --verbose    # Show detailed gaps
    python check_caiso_data_status.py --json       # Output as JSON
"""
...
DATASETS = {
    ...
    "lmp_day_ahead_hourly": {
        "dir": CAISO_DATA_DIR / "csv_files/lmp_day_ahead_hourly",
        "pattern": "*_lmp_day_ahead_*.csv",
        "description": "LMP Day-Ahead Hourly",
        "min_file_size_kb": 50,
    },
    "lmp_real_time_5_min": {
        "dir": CAISO_DATA_DIR / "csv_files/lmp_real_time_5_min",
        "pattern": "*_lmp_real_time_5_min*.csv",
        "description": "LMP Real-Time 5-Min",
        "min_file_size_kb": 100,
    },
    "lmp_real_time_15_min": {
        "dir": CAISO_DATA_DIR / "csv_files/lmp_real_time_15_min",
        "pattern": "*_lmp_real_time_15_min*.csv",
        "description": "LMP Real-Time 15-Min",
        "min_file_size_kb": 50,
    },
    "as_prices": {
        "dir": CAISO_DATA_DIR / "csv_files/as_prices",
        "pattern": "*_as_prices*.csv",
        "description": "Ancillary Service Prices",
        "min_file_size_kb": 10,
    },
    "fuel_mix": {
        "dir": CAISO_DATA_DIR / "csv_files/fuel_mix",
        "pattern": "*_fuel_mix*.csv",
        "description": "Fuel Mix",
        "min_file_size_kb": 5,
    },
    "load": {
        "dir": CAISO_DATA_DIR / "csv_files/load",
        "pattern": "*_load*.csv",
...
def print_status_report(statuses: List[Dict], verbose: bool = False):
    ...
    print("=" * 80)
    print("CAISO DATA STATUS REPORT")
...
def main():
    parser = argparse.ArgumentParser(
        description="Check status of CAISO datasets"
    )
    parser.add_argument(
        "--verbose", "-v",
        action="store_true",
