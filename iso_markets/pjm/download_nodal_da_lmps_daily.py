#!/usr/bin/env python3
"""
Download PJM Day-Ahead Nodal LMP Prices - DAILY chunks to handle 50K row limit
...
Usage:
    python download_nodal_da_lmps_daily.py --start-date 2023-10-07 --end-date 2025-10-06
    python download_nodal_da_lmps_daily.py --year 2024
"""
...
def main():
    parser = argparse.ArgumentParser(
        description='Download PJM Day-Ahead Nodal LMPs (ALL nodes, daily chunks)'
    )
    ...
    logger.info("⚠️  Downloading ALL 22,528 pnodes, day by day")
    logger.info("")
