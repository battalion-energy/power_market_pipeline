#!/usr/bin/env python3
"""
NYISO Data Status Checker

Provides comprehensive status report on all NYISO datasets:
...
Usage:
    python check_nyiso_data_status.py
    python check_nyiso_data_status.py --verbose    # Show detailed gaps
    python check_nyiso_data_status.py --json       # Output as JSON
"""
...
# Data directory
NYISO_DATA_DIR = Path(os.getenv('NYISO_DATA_DIR', '/pool/ssd8tb/data/iso/NYISO_data'))

# Dataset configurations
DATASETS = {
    "lmp_day_ahead_hourly": {
        "dir": NYISO_DATA_DIR / "csv_files/lmp_day_ahead_hourly",
        "pattern": "*_lmp_day_ahead_hourly.csv",
        "description": "LMP Day-Ahead Hourly",
        "min_file_size_kb": 50,
    },
    "lmp_real_time_5_min": {
        "dir": NYISO_DATA_DIR / "csv_files/lmp_real_time_5_min",
        "pattern": "*_lmp_real_time_5_min.csv",
        "description": "LMP Real-Time 5-Min",
        "min_file_size_kb": 200,
    },
    "as_day_ahead_hourly": {
        "dir": NYISO_DATA_DIR / "csv_files/as_day_ahead_hourly",
        "pattern": "*_as_day_ahead_hourly.csv",
        "description": "Ancillary Services Day-Ahead Hourly",
        "min_file_size_kb": 20,
    },
    "as_real_time_5_min": {
        "dir": NYISO_DATA_DIR / "csv_files/as_real_time_5_min",
        "pattern": "*_as_real_time_5_min.csv",
        "description": "Ancillary Services Real-Time 5-Min",
        "min_file_size_kb": 50,
    },
    "load": {
        "dir": NYISO_DATA_DIR / "csv_files/load",
        "pattern": "*_load.csv",
        "description": "Load Data",
        "min_file_size_kb": 10,
    },
    "fuel_mix": {
        "dir": NYISO_DATA_DIR / "csv_files/fuel_mix",
        "pattern": "*_fuel_mix.csv",
...
def print_status_report(statuses: List[Dict], verbose: bool = False):
    ...
    print("=" * 80)
    print("NYISO DATA STATUS REPORT")
...
def main():
    parser = argparse.ArgumentParser(
        description="Check status of NYISO datasets"
    )
    parser.add_argument(
        "--verbose", "-v",
        action="store_true",
