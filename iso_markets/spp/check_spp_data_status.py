#!/usr/bin/env python3
"""
SPP Data Status Checker

Provides comprehensive status report on all SPP datasets:
...
Usage:
    python check_spp_data_status.py
    python check_spp_data_status.py --verbose    # Show detailed gaps
    python check_spp_data_status.py --json       # Output as JSON
"""
...
DATASETS = {
    ...
    "rt_lmp_daily": {
        ...
        "pattern": "SPP_rt_lmp_*.csv",
        "description": "Real-Time LMP Daily",
        "min_file_size_kb": 200,
    },
    "da_lmp_nodal": {
        "dir": SPP_DATA_DIR / "csv_files/da_lmp_nodal",
        "pattern": "SPP_da_lmp_nodal_*.csv",
        "description": "Day-Ahead LMP Nodal",
        "min_file_size_mb": 5,
    },
    "rt_lmp_nodal": {
        "dir": SPP_DATA_DIR / "csv_files/rt_lmp_daily_nodal",
        "pattern": "SPP_rt_lmp_nodal_*.csv",
    ...
    "rt_mcp_daily": {
        ...
        "pattern": "SPP_rt_mcp_*.csv",
        "description": "Real-Time Market Clearing Prices",
        "min_file_size_kb": 100,
    },
}
...
def main():
    parser = argparse.ArgumentParser(
        description="Check status of SPP datasets"
    )
    parser.add_argument(
        "--verbose", "-v",
        action="store_true",
